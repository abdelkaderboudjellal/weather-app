...
const search = () => {
  ...
  const getWeatherDetails = (
    ...
    const weatherIpa_Url = `https://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${lon}&appid=${process.env.NEXT_PUBLIC_Api_key}`;
  ...
  async function getServerSideProps(values: string) {
    const geocoing_ipa_url: string = `https://api.openweathermap.org/geo/1.0/direct?q=${values}&limit=1&appid=${process.env.NEXT_PUBLIC_Api_key}`;
